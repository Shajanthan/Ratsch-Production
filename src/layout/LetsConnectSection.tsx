              ...
              <div className="uppercase">
                <div className="py-2 md:py-3">
                  ...
                  <div className="py-2 md:py-3">
                    <input
                      type="text"
                      className="border hover:cursor-default border-[#333333] hover:border-[#FF0000] transition-all duration-500 rounded-md py-3 md:py-4 bg-[#333333] w-full lg:w-3/4 focus:ring-0 focus:outline-none px-2 text-sm md:text-base"
                ...
                <div className="py-2 md:py-3">
                  ...
                  <div className="py-2 md:py-3">
                    <textarea
                      ...
                      name=""
                      id=""
                      className="border hover:cursor-default border-[#333333] hover:border-[#FF0000] transition-all duration-500 rounded-md py-3 md:py-4 bg-[#333333] w-full lg:w-3/4 focus:ring-0 focus:outline-none px-2 text-sm md:text-base resize-none"
                    ></textarea>
                  </div>
                </div>
