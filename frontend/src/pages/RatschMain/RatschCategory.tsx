  ...
  return (
    <div id="ratsch-category" className="max-w-5xl mx-auto py-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative p-2">
        <RevealOnScroll>
          <div className="group h-[400px] lg:h-[550px] rounded-3xl flex items-center justify-center relative overflow-hidden">
            <div className="relative w-full h-full">
              ...
              <div className="absolute bottom-6 left-0 right-0 z-10 flex flex-col items-center pb-10 transition-transform duration-500 group-hover:-translate-y-1">
                ...
                <button
                  ...
                  className="mt-10 text-center capitalize lg:text-lg text-base text-white bg-[#00CF69] p-4 px-8 rounded-full hover:scale-105 hover:shadow-lg hover:shadow-black/30 transition-all duration-300 cursor-pointer"
                >
                  Let's Design
                </button>
              </div>
            ...
            <div className="relative w-full h-full">
              ...
              <div className="absolute bottom-6 left-0 right-0 z-10 flex flex-col items-center pb-10 transition-transform duration-500 group-hover:-translate-y-1">
                ...
                <button
                  ...
                  className="mt-10 text-center capitalize lg:text-lg text-base text-white bg-[#0557B2] p-4 px-8 rounded-full hover:scale-105 hover:shadow-lg hover:shadow-black/30 transition-all duration-300 cursor-pointer"
                >
                  Tell your story
                </button>
              </div>
