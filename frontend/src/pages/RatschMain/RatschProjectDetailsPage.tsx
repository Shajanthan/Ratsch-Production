...
const RatschProjectDetailsPage: React.FC = () => {
  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-white text-[#02244A] flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative w-full min-h-[80vh] overflow-hidden p-3">
        <img
          src={project.image}
          alt={`${project.titleLine} ${project.titleLine2}`}
          className="absolute inset-0 h-full w-full object-cover p-3 rounded-[50px]"
        />
        <div className="absolute inset-0 z-10 pointer-events-none p-2">
      ...
      <div className="relative w-full py-12">
        <div className="bg-white z-10 relative">
          <div className="container lg:max-w-[1400px] mx-auto text-[#02244A] px-4 py-20">
            {/* Overview Section */}
      ...
      <div className="relative w-full bg-white pb-12 overflow-hidden">
        <img
          src="https://res.cloudinary.com/dybv1h20q/image/upload/v1774929840/Latest_Projects_Frame_1_ncypeb.png"
          alt=""
          className="absolute inset-0 z-0 h-full w-full object-cover opacity-100 pointer-events-none"
        />
...
export default RatschProjectDetailsPage;
