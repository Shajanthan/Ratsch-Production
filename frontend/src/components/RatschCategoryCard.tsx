...
interface RatschCategoryCardItem {
...
interface RatschCategoryCardProps {
  title?: string;
  desc?: string;
  items?: RatschCategoryCardItem[];
}

function ProjectTile({ item }: { item: RatschCategoryCardItem }) {
  return (
...
const RatschCategoryCard: React.FC<RatschCategoryCardProps> = ({
  title,
  desc,
  items = [],
}) => {
...
export default RatschCategoryCard;
